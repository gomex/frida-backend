...
var presenter = require('lib/services/publisher/presenter/column');
...
var factory = require('test/factories/column-attributes').column;
var metadataFactory = require('test/factories/column-attributes').metadata;
var columnist = require('lib/services/columnist');

describe('lib/services/publisher/presenter/column.js', () => {
