...
newsSchema.methods.isScheduled = function() {
  return this.status == 'scheduled';
};

newsSchema.methods.isPending = function() {
...
newsSchema.methods.generateUrl = function() {
...
newsSchema.query.byArea = function(area) {
  return this
    .where('metadata.area').equals(area)
    .byLayouts(['post', 'tabloid_news', 'special']);
};

newsSchema.query.byRegion = function(region) {
  return this
    .where('region').equals(region)
    .byLayouts('tabloid_news');
};

newsSchema.query.byColumnist = function(columnist) {
  return this
    .where('metadata.columnist').equals(columnist)
    .byLayouts('column');
};

newsSchema.query.byLayouts = function(layouts) {
  return this
    .where('metadata.layout').in(layouts);
};

newsSchema.query.byService = function(service) {
  return this
    .byLayouts(['post', 'tabloid_news'])
    .where('tags').in([service]);
};

newsSchema.query.publisheds = function() {
...
News.getServiceListPath = function(service) {
  var paths = {
    hojenahistoria: 'hoje-na-historia',
