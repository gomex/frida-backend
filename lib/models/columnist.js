function all() {
  return [
    ...
    },
    {
      ...
      'description': 'Armando Boito Jr. é professor Titular de Ciência Política da Unicamp e editor da revista Crítica Marxista e um dos fundadores do Centro de Estudos Marxistas (Cemarx) do IFCH-Unicamp.',
    ...
    },
    {
      ...
      'name': 'Igor Fuser',
      'path': 'igor-fuser',
      'description': 'Igor Fuser é professor do curso de Relações Internacionais na Universidade Federal do ABC (UFABC). Tem mestrado em Relações Internacionais pela Unesp e doutorado em Ciência Política pela USP. É autor de vários livros sobre política internacional e sobre as lutas sociais na América Latina.',
    ...
    },
    {
      ...
      'description': 'Geraldina Colotti é jornalista e escritora italiana. É responsável pela sessão da América Latina do jornal O Manifesto e diretora da edição italiana da revista francesa de política internacional Le Monde Diplomatique.',
    ...
    },
    {
      ...
      'description': 'Makota Célia Gonçalves Souza é jornalista, empreendedora social da Rede Ashoka e coordenadora nacional do Centro Nacional de Africanidade e Resistência Afro-Brasileira (CENARAB).',
