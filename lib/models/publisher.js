...
function publishRadioDataFile(news) {
  var newsTypesWithArea = ['post', 'column'];
  var tags = (typeof news.metadata.tags !== 'undefined') ? news.metadata.tags : [];
  function checkRadio(t) {
    return (t == 'radio') || (t == 'rádio');
  }

  if(_.contains(newsTypesWithArea, news.metadata.layout) && _.some(tags, checkRadio)) {
