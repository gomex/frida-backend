  ...
  return {
    ...
    updateById: function(id, item, callback) {
      ...
      if (!!item.metadata && typeof item.metadata === 'string') {
        ...
        updatedItem.metadata.newTitle = item.metadata.title;
        updatedItem.metadata.title;
      }
