...
module.exports =
{
  ...
  getAll: function(callback) {
    News.find({}).sort('-created_at').limit(FRIDA_FRONTEND_NEWS_LIMIT).exec(function(err, news) {
  ...
  updateById: function(id, item, callback) {
    ...
    News.findOneAndUpdate({_id: ObjectId(id)}, {$set: updatedItem}, function(err, _result){
