...
function createRadioagenciaHome(callback) {
  ...
  async.parallel({
    ...
    service_06: (callback) => createPost({tags: ['conectados']}, callback),
    service_07: (callback) => createPost({tags: ['momentoagroecologico']}, callback),
    service_08: (callback) => createPost({tags: ['falaai']}, callback),
