...
function createRadioagenciaHome(callback) {
  ...
  async.parallel({
    ...
    service_01: (callback) => createPost({tags: ['alimentoesaude']}, callback),
    service_02: (callback) => createPost({tags: ['mosaicocultural']}, callback),
    service_03: (callback) => createPost({tags: ['conectados']}, callback),
    service_04: (callback) => createPost({tags: ['momentoagroecologico']}, callback),
    service_05: (callback) => createPost({tags: ['falaai']}, callback),
    radio_01: (callback) => createPost({tags: ['programape']}, callback),
    radio_02: (callback) => createPost({tags: ['programasp']}, callback),
...
function createHome(callback) {
  ...
  async.parallel({
    ...
    article: (callback) => createPost(null, callback),
