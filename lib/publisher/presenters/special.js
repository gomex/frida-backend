...
var optionsPresenter = require('./options');
var textPresenter = require('./special/text');
var imagePresenter = require('./special/image');
var linksPresenter = require('./special/links');
...
function getListData(special, options) {
  return Object.assign(
    {
      path: special.metadata.url,
      hat: 'especial',
    ...
    coverPresenter.getData(special),
    optionsPresenter.getData(special, options)
  );
}
