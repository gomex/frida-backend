...
function getData(home) {
  return {
    ...
    tabloid_ce: presenters.getListData(home.tabloid_ce),
    tabloid_mg: presenters.getListData(home.tabloid_mg),
    tabloid_pr: presenters.getListData(home.tabloid_pr),
    tabloid_pe: presenters.getListData(home.tabloid_pe),
    tabloid_rj: presenters.getListData(home.tabloid_rj)
  };
}
