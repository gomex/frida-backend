...
function buildHome(callback) {
  ...
  async.parallel({
    ...
    ceara: async.apply(newsRepository.find, publishedTabloid('tabloid_ce'), tabloidProjection, 1, sortByPublishedDate),
    ...
    pernambuco: async.apply(newsRepository.find, publishedTabloid('tabloid_pe'), tabloidProjection, 1, sortByPublishedDate),
    rio_de_janeiro: async.apply(newsRepository.find, publishedTabloid('tabloid_rj'), tabloidProjection, 1, sortByPublishedDate),
    last_news: async.apply(newsRepository.find, lastNews, newsProjection, 5, sortByPublishedDate),
